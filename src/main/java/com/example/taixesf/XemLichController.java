...
public class XemLichController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tuanle.setText("Tuần : 2024/06/24 -> 2024/06/30");
    }
    @FXML
    ...
    void chonCa(MouseEvent event) {
        LocalDate today=LocalDate.now();
        Timestamp todaynow= Timestamp.valueOf(today.atStartOfDay());
        WorkingshiftObject w=table.getSelectionModel().getSelectedItem();
        if(w.getWorkingshift_date().before(todaynow)){
            Alert alert2 = new Alert(Alert.AlertType.INFORMATION);
            alert2.setTitle("Thông báo");
            alert2.setHeaderText("Không thể chọn ca này");
            alert2.setContentText("Không thể chọn ca trong quá khứ");
            alert2.showAndWait();
        }else {
            if(w.getWorkingshift_drivernumber()==0){
                Alert alert2 = new Alert(Alert.AlertType.INFORMATION);
                alert2.setTitle("Thông báo");
                alert2.setHeaderText("Không thể đăng ký ca này");
    ...
    public void truoc(ActionEvent event) {
        if(ngaytao.equals(Timestamp.valueOf("2024-06-27 00:00:00"))){
            ngaytao = Timestamp.valueOf("2024-06-17 00:00:00");
            tuanle.setText("Tuần : 2024/06/17 -> 2024/06/23");
        }else if(ngaytao.equals(Timestamp.valueOf("2024-07-01 00:00:00")) ) {
            ngaytao = Timestamp.valueOf("2024-06-27 00:00:00");
            tuanle.setText("Tuần : 2024/06/24 -> 2024/06/30");
        }
        setUser(user);
    }
    ...
    public void sau(ActionEvent event) {
        if(ngaytao.equals(Timestamp.valueOf("2024-06-17 00:00:00"))){
            ngaytao = Timestamp.valueOf("2024-06-27 00:00:00");
            tuanle.setText("Tuần : 2024/06/24 -> 2024/06/30");
        }else if(ngaytao.equals(Timestamp.valueOf("2024-06-27 00:00:00")) ) {
            ngaytao = Timestamp.valueOf("2024-07-01 00:00:00");
            tuanle.setText("Tuần : 2024/07/01 -> 2024/07/07");
        }
