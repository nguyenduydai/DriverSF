...
public class AdminCaController implements Initializable {
    ...
    private ArrayList<WorkingshiftObject> listn ;
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        listn = wf.getWorkingshifts(ngaytao,"workingshift_area_id>0");
    ...
    private ArrayList<WorkingshiftObject> listall=wf.getWorkingshifts(ngaytao,"workingshift_area_id>0");
    @FXML
    ...
    public void sau(ActionEvent event) {
        if(ngaytao.equals(Timestamp.valueOf("2024-06-17 00:00:00"))){
            ...
            ngaytao = Timestamp.valueOf("2024-06-28 00:00:00");
